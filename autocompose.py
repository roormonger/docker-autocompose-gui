...
# SENSITIVE_ENV_VARS list is removed as per previous changes.
# Filtering is now primarily via AUTOCOMPOSE_EXCLUDE label or --full flag behavior.
...
def generate_compose(client, containers_to_inspect, include_all_env_vars, include_default_volumes):
    ...
    for container_name_or_id in containers_to_inspect:
        ...
        # Labels - Modified to NOT filter AUTOCOMPOSE_EXCLUDE
